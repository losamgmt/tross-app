 ...
 */
router.get('/system/settings/:key', asyncHandler(async (req, res) => {
 ...
 */
router.get('/system/maintenance', asyncHandler(async (req, res) => {
 ...
 */
router.put('/system/maintenance', asyncHandler(async (req, res) => {
 ...
 */
router.get('/system/sessions', asyncHandler(async (req, res) => {
 ...
 */
router.get('/system/logs/data', asyncHandler(async (req, res) => {
  const {
    page = 1,
    limit = 50,
    userId,
 ...
 */
router.get('/system/logs/auth', asyncHandler(async (req, res) => {
  const {
    page = 1,
    limit = 50,
    userId,
 ...
 */
router.get('/system/logs/summary', asyncHandler(async (req, res) => {
 ...
 */
router.get('/system/config/permissions', asyncHandler(async (req, res) => {
 ...
 */
router.get('/:entity/raw', asyncHandler(async (req, res) => {
  const { entity } = req.params;
