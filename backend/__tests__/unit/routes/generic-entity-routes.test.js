...
const ENTITIES = [
  ...
  },
  {
    ...
    createData: { customer_id: 1, total_amount: 200.0, status: "draft" },
  },
  {
    name: "contract",
  ...
  ({ name, routePath, router, sampleData, createData }) => {
    ...
    describe(`GET ${routePath}`, () => {
      ...
      test("should handle database errors", async () => {
        // Arrange
        GenericEntityService.findAll.mockRejectedValue(
    ...
    describe(`GET ${routePath}/:id`, () => {
      ...
      test("should handle database errors", async () => {
        // Arrange
        GenericEntityService.findById.mockRejectedValue(
          new Error("Database error"),
        );
    ...
    describe(`POST ${routePath}`, () => {
      ...
      test("should handle database errors during creation", async () => {
        // Arrange
        GenericEntityService.create.mockRejectedValue(
