  ...
  describe('sanitizeValue', () => {
    ...
    describe('email type', () => {
      it('lowercases and trims email values', () => {
        expect(sanitizeValue('  TEST@EXAMPLE.COM  ', { type: 'email' })).toBe('test@example.com');
      });
    ...
    describe('phone type', () => {
      it('trims phone values but preserves formatting', () => {
        expect(sanitizeValue('  (123) 456-7890  ', { type: 'phone' })).toBe('(123) 456-7890');
      });
    ...
    describe('unknown type', () => {
      it('passes unknown types through unchanged', () => {
        expect(sanitizeValue('test', { type: 'unknown_custom_type' })).toBe('test');
      });
    });
  });
