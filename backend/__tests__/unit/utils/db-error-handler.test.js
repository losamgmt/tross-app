...
const { handleDbError, buildDbErrorConfig, PG_ERROR_CODES } = require('../../../utils/db-error-handler');
  ...
  describe('handleDbError', () => {
    ...
    describe('FOREIGN_KEY_VIOLATION (23503)', () => {
      it('handles FK violation - referenced record not found', () => {
        ...
        error.code = '23503';
        error.detail = 'Key (customer_id)=(999) is not present in table "customers"';
