...
describe("SessionsService", () => {
  ...
  describe("forceLogoutUser", () => {
    ...
    it("should throw when trying to logout self", async () => {
      await expect(SessionsService.forceLogoutUser(1, 1)).rejects.toThrow(
    ...
    it("should throw when user not found", async () => {
      ...
      await expect(SessionsService.forceLogoutUser(999, 1)).rejects.toThrow(
    ...
    it("should rollback on database error", async () => {
      ...
      await expect(SessionsService.forceLogoutUser(10, 1)).rejects.toThrow(
        "Database error",
      );
  ...
  describe("revokeSession", () => {
    ...
    it("should throw when session not found", async () => {
      ...
      await expect(SessionsService.revokeSession(999, 1)).rejects.toThrow(
        "Session 999 not found or already revoked",
      );
    });
  });
  ...
  describe("reactivateUser", () => {
    ...
    it("should throw when user not found or not suspended", async () => {
      ...
      await expect(SessionsService.reactivateUser(999, 1)).rejects.toThrow(
        "User 999 not found or not suspended",
      );
    });
