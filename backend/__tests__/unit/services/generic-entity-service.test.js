  ...
  describe("findById", () => {
    ...
    describe("error handling", () => {
      ...
      test("should throw for negative ID", async () => {
        await expect(GenericEntityService.findById("user", -5)).rejects.toThrow(
          "id must be at least 1",
        );
      });

      test("should throw for zero ID", async () => {
        await expect(GenericEntityService.findById("user", 0)).rejects.toThrow(
          "id must be at least 1",
        );
      });
      ...
      test("should propagate database errors", async () => {
        ...
        // Act & Assert
        await expect(GenericEntityService.findById("user", 1)).rejects.toThrow(
          "Connection refused",
        );
      });
    });
  ...
  describe("findAll", () => {
    ...
    describe("error handling", () => {
      ...
      test("should propagate database errors", async () => {
        ...
        // Act & Assert
        await expect(GenericEntityService.findAll("user")).rejects.toThrow(
          "Connection refused",
        );
      });
    });
    ...
    describe("data validation", () => {
      test("should throw when data is null", async () => {
        await expect(
          ...
          "Data is required and must be an object for customer",
        );
      });
  ...
  describe("update", () => {
    ...
    describe("system protection", () => {
      ...
      test("should block updating priority on system role", async () => {
        ...
        db.query.mockResolvedValue({
          rows: [
            { id: 2, name: "manager", priority: 80, description: "Manager" },
          ],
        });
      ...
      test("should block updating multiple immutable fields on system role", async () => {
        ...
        db.query.mockResolvedValue({
          rows: [
            { id: 5, name: "customer", priority: 10, description: "Customer" },
          ],
        });

        // Act & Assert
        await expect(
          GenericEntityService.update("role", 5, {
            name: "renamed_customer",
            priority: 15,
          }),
        ).rejects.toThrow(
          /Cannot modify name, priority on system role: customer/,
        );
      });
  ...
  describe("delete", () => {
    ...
    describe("successful deletion", () => {
      ...
      test("should cascade delete dependents before deleting entity", async () => {
        ...
        expect(
          calls.some((call) => call[0].includes("DELETE FROM audit_logs")),
        ).toBe(true);
      });
    ...
    describe("error handling", () => {
      ...
      test("should throw error for invalid ID (zero)", async () => {
        // Act & Assert
        await expect(GenericEntityService.delete("role", 0)).rejects.toThrow();
      });

      test("should throw error for invalid ID (negative)", async () => {
        // Act & Assert
        await expect(GenericEntityService.delete("role", -1)).rejects.toThrow();
      });
    ...
    describe("system protection", () => {
      ...
      test("should block deleting system role (manager)", async () => {
        ...
        // Act & Assert
        await expect(GenericEntityService.delete("role", 2)).rejects.toThrow(
          "Cannot delete system role: manager",
        );
      });
      ...
      test("should block deleting system role (dispatcher)", async () => {
        ...
        // Act & Assert
        await expect(GenericEntityService.delete("role", 3)).rejects.toThrow(
          "Cannot delete system role: dispatcher",
        );
      });
      ...
      test("should block deleting system role (technician)", async () => {
        ...
        // Act & Assert
        await expect(GenericEntityService.delete("role", 4)).rejects.toThrow(
          "Cannot delete system role: technician",
        );
      });
      ...
      test("should block deleting system role (customer)", async () => {
        ...
        // Act & Assert
        await expect(GenericEntityService.delete("role", 5)).rejects.toThrow(
          "Cannot delete system role: customer",
        );
      });
