...
describe("StatsService", () => {
  ...
  describe("count", () => {
    ...
    it("should throw for unknown entity", async () => {
      ...
      await expect(
        StatsService.count("unknown_entity", mockReq),
  ...
  describe("countGrouped", () => {
    ...
    it("should throw for non-filterable group field", async () => {
      ...
      await expect(
        StatsService.countGrouped("work_order", mockReq, "not_a_field"),
      ).rejects.toThrow(
        "Cannot group by 'not_a_field' - not a filterable field",
      );
    });
  });
  ...
  describe("sum", () => {
    ...
    it("should throw for non-numeric field", async () => {
      ...
      await expect(
        StatsService.sum("work_order", mockReq, "status"),
      ).rejects.toThrow();
    });
    ...
    it("should throw for unknown entity", async () => {
      ...
      await expect(
        StatsService.sum("unknown_entity", mockReq, "amount"),
      ).rejects.toThrow("Unknown entity: unknown_entity");
    });
  ...
  describe("countGrouped with filters", () => {
    ...
    it("should throw for unknown entity", async () => {
      ...
      await expect(
        StatsService.countGrouped("unknown_entity", mockReq, "status"),
      ).rejects.toThrow("Unknown entity: unknown_entity");
    });
  });
