...
describe("Entity Registry", () => {
  ...
  describe("Entity Discovery", () => {
    ...
    test("getEntityMetadata throws for unknown entity", () => {
      expect(() => getEntityMetadata("nonexistent")).toThrow(
        "Unknown entity: nonexistent",
      );
    });
  });
  ...
  describe("RLS Requirements", () => {
    test.each(getBusinessEntityNames())(
      "%s has rlsResource (business entity)",
      (entityName) => {
        const meta = getEntityMetadata(entityName);
    ...
    test.each(getBusinessEntityNames())(
      "%s has fieldAccess (business entity)",
      (entityName) => {
        const meta = getEntityMetadata(entityName);
