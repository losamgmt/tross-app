/// DatabaseHealthCard - Organism for displaying database health information
///
/// Displays comprehensive health info for a single database:
/// - Database name
/// - Connection status (using Badge with status.badgeStyle)
/// - Response time
/// - Connection count
...
/// Organism component for displaying database health information
  ...
  Widget _buildHeader(ThemeData theme, AppSpacing spacing) {
    return Row(
      ...
      children: [
        ...
        AppBadge(label: status.label, style: status.badgeStyle, compact: true),
      ],
    );
  }
