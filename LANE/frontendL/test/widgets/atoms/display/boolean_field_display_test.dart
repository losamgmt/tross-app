  ...
  group('BooleanFieldDisplay', () {
    testWidgets('renders with label and true value', (tester) async {
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(body: BooleanFieldDisplay(value: true))),
      );
    ...
    testWidgets('renders with false value', (tester) async {
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(body: BooleanFieldDisplay(value: false))),
      );
    ...
    testWidgets('renders with null value', (tester) async {
      await tester.pumpWidget(
        MaterialApp(home: Scaffold(body: BooleanFieldDisplay(value: null))),
      );
    ...
    testWidgets('uses custom true label', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: true, trueLabel: 'Verified'),
          ),
        ),
      );
    ...
    testWidgets('uses custom false label', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: false, falseLabel: 'Not Verified'),
          ),
        ),
      );
    ...
    testWidgets('uses custom null label', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: null, nullLabel: 'Unknown'),
          ),
        ),
      );
    ...
    testWidgets('uses custom true icon', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: true, trueIcon: Icons.thumb_up),
          ),
        ),
      );
    ...
    testWidgets('hides icon when showIcon is false', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: true, showIcon: false),
          ),
        ),
      );
    ...
    testWidgets('uses custom true color', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: true, trueColor: Colors.blue),
          ),
        ),
      );
    ...
    testWidgets('uses custom false color', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: false, falseColor: Colors.red),
          ),
        ),
      );
    ...
    testWidgets('uses custom null color', (tester) async {
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: null, nullColor: Colors.orange),
          ),
        ),
      );
    ...
    testWidgets('applies custom value style', (tester) async {
      ...
      await tester.pumpWidget(
        MaterialApp(
          home: Scaffold(
            body: BooleanFieldDisplay(value: true, valueStyle: customStyle),
          ),
        ),
      );
